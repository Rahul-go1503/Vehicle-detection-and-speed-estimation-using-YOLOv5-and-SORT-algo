# vehicle-detection-and-speed-estimation-using-YOLOv5-and-SORT-algo

This project uses YOLOv5 for Vehicle detection and SORT(Simple Online and Realtime Tracker) for vehicle tracking
